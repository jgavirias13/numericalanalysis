...
/**
 * Created by jgavi on 27/10/2016.
 */

public class SalidaBiseccion {

    private ArrayList<ColumnaBiseccion> matriz;
    private Intervalo<Double,Double> respuesta;

    public SalidaBiseccion(){
        matriz = new ArrayList<>();
    }

    public void agregar(int n, double xi, double xs, double xm, double fxm, double error){
        matriz.add(new ColumnaBiseccion(n, xi, xs, xm, fxm, error));
    }

    public ArrayList<ColumnaBiseccion> getMatriz(){
        return this.matriz;
    }
...
class ColumnaBiseccion{
    ...
    public ColumnaBiseccion(int n, double xi, double xs, double xm, double fxm, double error){
        this.n = n;
        this.xi = xi;
        this.xs = xs;
        this.xm = xm;
