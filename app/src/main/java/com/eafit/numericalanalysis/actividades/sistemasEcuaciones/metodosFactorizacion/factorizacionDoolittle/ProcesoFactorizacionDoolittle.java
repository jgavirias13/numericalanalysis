...
public class ProcesoFactorizacionDoolittle extends AppCompatActivity implements View.OnClickListener{

    private SalidaFactorizacionDoolittle salida;
    private int etapa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_proceso_factorizacion_doolittle);
        ...
        salida = (SalidaFactorizacionDoolittle) Comunicacion.receive();
        etapa = 0;
        res = getResources();
