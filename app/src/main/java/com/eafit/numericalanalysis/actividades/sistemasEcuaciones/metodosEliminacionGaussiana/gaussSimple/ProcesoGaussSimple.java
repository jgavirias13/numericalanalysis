package com.eafit.numericalanalysis.actividades.sistemasEcuaciones.metodosEliminacionGaussiana.gaussSimple;
...
public class ProcesoGaussSimple extends AppCompatActivity implements View.OnClickListener{

    private SalidaGaussSimple salida;
    private int etapa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_proceso_gauss_simple);
        ...
        salida = (SalidaGaussSimple) Comunicacion.receive();
        etapa = 0;
        res = getResources();
        txtTitulo.setText(res.getString(R.string.etapa)+" "+(etapa));
        double[][] matrizEtapa = salida.getEtapas().get(etapa);
        txtMatriz.setText(armarSalida(matrizEtapa));
        txtMultiplicador.setText(armarMultiplicador(salida.getMultiplicadores().get(etapa)));
