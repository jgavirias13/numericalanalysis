package com.eafit.numericalanalysis.actividades.sistemasEcuaciones.metodosFactorizacion.factorizacionPivoteo;
...
import com.eafit.numericalanalysis.metodos.sistemasEcuaciones.FactorizacionPivoteo;
import com.eafit.numericalanalysis.util.Comunicacion;

public class IngresoFactorizacionPivoteo extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingreso_factorizacion_pivoteo);
    ...
    public void onClick(View view){
        switch(view.getId()){
            case R.id.btnCalcularGauss:
                try {
                    EstadoEcuaciones estado = EstadoEcuaciones.solicitarEstado();
                    final SalidaFactorizacionPivoteo resultado = FactorizacionPivoteo.evaluar(estado.getA(),estado.getB());
                    String salida = "";
                    ...
                    btnCalcular.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent proceso = new Intent(v.getContext(), ProcesoFactorizacionPivoteo.class);
