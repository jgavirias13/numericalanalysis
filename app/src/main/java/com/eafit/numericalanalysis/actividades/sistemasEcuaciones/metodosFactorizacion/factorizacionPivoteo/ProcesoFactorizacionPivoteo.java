...
public class ProcesoFactorizacionPivoteo extends AppCompatActivity implements View.OnClickListener{

    private SalidaFactorizacionPivoteo salida;
    private int etapa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_proceso_factorizacion_pivoteo);
        ...
        salida = (SalidaFactorizacionPivoteo) Comunicacion.receive();
        etapa = 0;
        res = getResources();
