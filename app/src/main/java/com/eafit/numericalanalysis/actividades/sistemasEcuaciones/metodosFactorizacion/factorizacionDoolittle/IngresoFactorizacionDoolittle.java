package com.eafit.numericalanalysis.actividades.sistemasEcuaciones.metodosFactorizacion.factorizacionDoolittle;
...
import com.eafit.numericalanalysis.metodos.sistemasEcuaciones.Doolittle;
...
public class IngresoFactorizacionDoolittle extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingreso_factorizacion_doolittle);
    ...
    public void onClick(View view){
        switch(view.getId()){
            case R.id.btnCalcularGauss:
                try {
                    EstadoEcuaciones estado = EstadoEcuaciones.solicitarEstado();
                    final SalidaFactorizacionDoolittle resultado = Doolittle.evaluar(estado.getA(),estado.getB());
                    String salida = "";
                    ...
                    btnCalcular.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent proceso = new Intent(v.getContext(), ProcesoFactorizacionDoolittle.class);
            ...
            case R.id.btnHelp:
                ...
                help.putExtra("id", R.string.help_doolittle);
                startActivity(help);
                break;
        }
    }
