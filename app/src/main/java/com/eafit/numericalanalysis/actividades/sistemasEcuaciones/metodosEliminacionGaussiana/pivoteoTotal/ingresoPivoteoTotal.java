package com.eafit.numericalanalysis.actividades.sistemasEcuaciones.metodosEliminacionGaussiana.pivoteoTotal;
...
import com.eafit.numericalanalysis.actividades.sistemasEcuaciones.metodosEliminacionGaussiana.pivoteoParcial.ProcesoPivoteoParcial;
...
public class IngresoPivoteoTotal extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingreso_pivoteo_total);
    ...
    public void onClick(View view){
        switch(view.getId()){
            case R.id.btnCalcularGauss:
                try {
                    final SalidaPivoteoTotal resultado = PivoteoTotal.evaluar(matrizAumentada);
                    String salida = "";
                    ...
                    btnCalcular.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent proceso = new Intent(v.getContext(), ProcesoPivoteoTotal.class);
