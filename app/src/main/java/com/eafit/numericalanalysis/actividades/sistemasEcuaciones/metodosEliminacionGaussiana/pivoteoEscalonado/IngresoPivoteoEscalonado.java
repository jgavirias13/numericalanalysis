...
import com.eafit.numericalanalysis.actividades.sistemasEcuaciones.metodosEliminacionGaussiana.pivoteoTotal.ProcesoPivoteoTotal;
...
import com.eafit.numericalanalysis.metodos.sistemasEcuaciones.PivoteoEscalonado;
...
public class IngresoPivoteoEscalonado extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingreso_pivoteo_escalonado);
    ...
    public void onClick(View view){
        switch(view.getId()){
            case R.id.btnCalcularGauss:
                try {
                    final SalidaPivoteoEscalonado resultado = PivoteoEscalonado.evaluar(matrizAumentada);
                    String salida = "";
                    ...
                    btnCalcular.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent proceso = new Intent(v.getContext(), ProcesoPivoteoEscalonado.class);
