...
public class ProcesoPivoteoTotal extends AppCompatActivity implements View.OnClickListener{

    private SalidaPivoteoTotal salida;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_proceso_pivoteo_total);
        ...
        salida = (SalidaPivoteoTotal) Comunicacion.receive();
        iteracion = 0;
        res = getResources();
