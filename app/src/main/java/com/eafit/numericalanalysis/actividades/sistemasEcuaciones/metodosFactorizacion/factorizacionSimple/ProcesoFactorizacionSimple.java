...
public class ProcesoFactorizacionSimple extends AppCompatActivity implements View.OnClickListener{

    private SalidaFactorizacionGaussina salida;
    private int etapa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_proceso_factorizacion_simple);
        ...
        salida = (SalidaFactorizacionGaussina) Comunicacion.receive();
        etapa = 0;
        res = getResources();
