...
public class IngresoGaussSimple extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingreso_gauss_simple);
    ...
    public void onClick(View view){
        switch(view.getId()){
            case R.id.btnCalcularGauss:
                try {
                    final SalidaGaussSimple resultado = EliminacionGaussiana.evaluar(matrizAumentada);
                    String salida = "";
                    ...
                    btnCalcular.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent proceso = new Intent(v.getContext(), ProcesoGaussSimple.class);
