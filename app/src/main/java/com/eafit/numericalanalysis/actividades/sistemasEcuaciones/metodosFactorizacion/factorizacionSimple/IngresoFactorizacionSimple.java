package com.eafit.numericalanalysis.actividades.sistemasEcuaciones.metodosFactorizacion.factorizacionSimple;
...
public class IngresoFactorizacionSimple extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingreso_factorizacion_simple);
    ...
    public void onClick(View view){
        switch(view.getId()){
            case R.id.btnCalcularGauss:
                try {
                    EstadoEcuaciones estado = EstadoEcuaciones.solicitarEstado();
                    final SalidaFactorizacionGaussina resultado = FactorizacionGaussiana.evaluar(estado.getA(),estado.getB());
                    String salida = "";
                    ...
                    btnCalcular.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent proceso = new Intent(v.getContext(), ProcesoFactorizacionSimple.class);
