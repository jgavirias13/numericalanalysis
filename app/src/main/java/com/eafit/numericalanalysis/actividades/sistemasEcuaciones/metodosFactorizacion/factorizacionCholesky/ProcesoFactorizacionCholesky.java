...
public class ProcesoFactorizacionCholesky extends AppCompatActivity implements View.OnClickListener{

    private SalidaFactorizacionCholesky salida;
    private int etapa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_proceso_factorizacion_cholesky);
        ...
        salida = (SalidaFactorizacionCholesky) Comunicacion.receive();
        etapa = 0;
        res = getResources();
